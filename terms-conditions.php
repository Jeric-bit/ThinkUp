...
<head>
  ...
  <title>Terms & Conditions | ThinkUp</title>
  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      line-height: 1.7;
      padding-top: 100px; /* IMPORTANT: Prevents header overlapping content */
    }
    ...
    @media (max-width: 992px) { .content-card { padding: 40px; } .terms-hero { padding: 40px 0 30px; } }
  ...
  <main>
    ...
    <div class="container center-wrapper">
      <div class="content-card">
        ...
        <button class="print-btn" onclick="window.print()"><i class="bi bi-printer"></i> Print Terms</button>

        <p class="text-block" style="font-size: 1.1rem; text-align: center; margin-top: 40px;">
          Please read these terms carefully. By accessing ThinkUp, you agree to be bound by these conditions.
        </p>

        <nav class="category-tabs">
          <a href="#acceptance" class="tab-link">Acceptance</a>
          <a href="#accounts" class="tab-link">Accounts</a>
          <a href="#conduct" class="tab-link">Conduct</a>
          <a href="#liability" class="tab-link">Liability</a>
          <a href="#changes" class="tab-link">Changes</a>
        </nav>

        <div id="termsContainer">
            
            <div id="acceptance" class="accordion-item">
                <button class="accordion-header">
                    1. Acceptance of Terms <i class="bi bi-chevron-down"></i>
                </button>
                <div class="accordion-content">
                    <p class="text-block">By creating an account or accessing ThinkUp, you confirm that you are at least 13 years of age and meet the eligibility requirements to use this platform. If you do not agree to these terms, please do not use our services.</p>
                </div>
            </div>

            <div id="accounts" class="accordion-item">
                <button class="accordion-header">
                    2. User Accounts <i class="bi bi-chevron-down"></i>
                </button>
                <div class="accordion-content">
                    <p class="text-block">You are responsible for maintaining the security of your account:</p>
                    <ul class="custom-list">
                        <li><strong>Accuracy:</strong> You must provide accurate and complete information during registration.</li>
                        <li><strong>Security:</strong> You are responsible for keeping your password confidential. ThinkUp is not liable for any loss due to unauthorized account use.</li>
                        <li><strong>Responsibility:</strong> You are responsible for all activities that occur under your account.</li>
                    </ul>
                </div>
            </div>

            <div id="conduct" class="accordion-item">
                <button class="accordion-header">
                    3. User Conduct <i class="bi bi-chevron-down"></i>
                </button>
                <div class="accordion-content">
                    <p class="text-block">We want ThinkUp to be a safe place for learning. The following actions are prohibited:</p>
                    <ul class="custom-list">
                        <li>Using the platform to cheat, plagiarize, or engage in academic dishonesty.</li>
                        <li>Posting offensive, hateful, or inappropriate content in quizzes or comments.</li>
                        <li>Attempting to hack, disrupt, or interfere with the platform's security.</li>
                    </ul>
                </div>
            </div>

            <div id="liability" class="accordion-item">
                <button class="accordion-header">
                    4. Limitation of Liability <i class="bi bi-chevron-down"></i>
                </button>
                <div class="accordion-content">
                    <p class="text-block">
                        ThinkUp is provided "as is." While we strive for accuracy, we do not guarantee that the content on the platform is error-free. We are not liable for any academic consequences (such as failing a test) resulting from the use of our quizzes.
                    </p>
                </div>
            </div>

            <div id="changes" class="accordion-item">
                <button class="accordion-header">
                    5. Changes to Terms <i class="bi bi-chevron-down"></i>
                </button>
                <div class="accordion-content">
                    <p class="text-block">
                        We may modify these terms at any time. If we make material changes, we will notify you through the platform or via email. Your continued use of ThinkUp after such changes constitutes your acceptance of the new terms.
                    </p>
                    <p class="text-block" style="margin-top: 20px;">
                        <strong>Questions?</strong> Contact us at: <a href="mailto:support@thinkup.com" class="email-link">support@thinkup.com</a>
                    </p>
                </div>
            </div>
