...
<head>
  ...
  <title>Create Quizzes | ThinkUp</title>
...
<body>
  ...
  <main>
    <section class="feature-hero animate-load">
      <div class="container">
        <h1 class="feature-title">Create Quizzes <span style="color: var(--teal);">Effortlessly</span></h1>
        <p class="feature-subtitle">
          Say goodbye to complicated tools. With ThinkUp, you can build engaging, interactive quizzes in minutes. Just type, click, and launch.
        </p>
        <img src="https://images.unsplash.com/photo-1761353672906-b63d3f26070c?auto=format&fit=crop&q=80&w=880" alt="Create Dashboard" style="max-height: 300px; object-fit: contain; margin-top: 20px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
      </div>
    </section>

    <section class="steps-section">
      <div class="container">
        <h2 style="text-align: center; font-family: var(--font-heading); color: var(--navy); font-size: 2.5rem;">How it works</h2>
        
        <div class="steps-grid">
          <div class="step-card">
            <div class="step-number">1</div>
            <h3 class="step-title">Choose a Topic</h3>
            <p>Select a category or start from scratch. Give your quiz a catchy title and description.</p>
          </div>
          
          <div class="step-card">
            <div class="step-number">2</div>
            <h3 class="step-title">Add Questions</h3>
            <p>Mix it up with multiple choice, true/false, or identification questions. Add images for visual flair.</p>
          </div>
          
          <div class="step-card">
            <div class="step-number">3</div>
            <h3 class="step-title">Customize & Share</h3>
            <p>Set time limits and privacy settings. Then, grab the link and challenge your friends!</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="tools-section">
      <div class="container">
        <h2 class="tools-heading">Everything you need</h2>
        <div class="tools-grid">
          <div class="tool-pill"><i class="bi bi-clock-history"></i> Timer Settings</div>
          <div class="tool-pill"><i class="bi bi-images"></i> Image Support</div>
          <div class="tool-pill"><i class="bi bi-shuffle"></i> Randomize Answers</div>
          <div class="tool-pill"><i class="bi bi-phone"></i> Mobile Friendly</div>
          <div class="tool-pill"><i class="bi bi-bar-chart-fill"></i> Instant Grading</div>
          <div class="tool-pill"><i class="bi bi-eye-slash"></i> Private Mode</div>
        </div>
      </div>
    </section>
    ...
    <section class="bottom-cta">
      <div class="container">
        <h2 style="font-family: var(--font-heading); font-size: 2.5rem; margin-bottom: 30px; color: var(--navy);">Ready to start creating?</h2>
        <a href="sign-up.php" class="cta-btn-lg">Make a Quiz Now</a>
      </div>
    </section>
  ...
  <footer class="footer">
    ...
    <div class="footer-bottom">© 2025 ThinkUp. All Rights Reserved.</div>
  </footer>
