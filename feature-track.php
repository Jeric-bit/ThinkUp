...
<head>
  ...
  <title>Track Your Growth | ThinkUp</title>
...
<body>
  ...
  <main>
    <section class="feature-hero animate-load">
      <div class="container">
        <h1 class="feature-title">Track Your <span style="color: var(--teal);">Growth</span></h1>
        <p class="feature-subtitle">
          See how far you’ve come. Visualize your progress, spot improvement areas, and celebrate your wins with smart history logs.
        </p>
        <img src="https://i.pinimg.com/736x/a5/79/1b/a5791b55bad0a35f696bf61abaf5fcde.jpg" alt="Growth Tracker" style="max-height: 300px; object-fit: contain; margin-top: 20px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
      </div>
    </section>

    <section class="steps-section">
      <div class="container">
        <h2 style="text-align: center; font-family: var(--font-heading); color: var(--navy); font-size: 2.5rem;">The Path to Mastery</h2>
        
        <div class="steps-grid">
          <div class="step-card">
            <div class="step-number">1</div>
            <h3 class="step-title">Take Quizzes</h3>
            <p>Engage with different topics. Every answer you give is automatically saved to your history.</p>
          </div>
          
          <div class="step-card">
            <div class="step-number">2</div>
            <h3 class="step-title">Get Insights</h3>
            <p>View instant scores and detailed breakdowns. See exactly where you excelled and where to improve.</p>
          </div>
          
          <div class="step-card">
            <div class="step-number">3</div>
            <h3 class="step-title">Level Up</h3>
            <p>Watch your stats climb over time. Re-take quizzes to beat your high score and master the subject.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="tools-section">
      <div class="container">
        <h2 class="tools-heading">Your Data, Visualized</h2>
        <div class="tools-grid">
          <div class="tool-pill"><i class="bi bi-graph-up-arrow"></i> Progress Charts</div>
          <div class="tool-pill"><i class="bi bi-clock-history"></i> History Logs</div>
          <div class="tool-pill"><i class="bi bi-trophy"></i> High Scores</div>
          <div class="tool-pill"><i class="bi bi-calendar-check"></i> Streak Tracking</div>
          <div class="tool-pill"><i class="bi bi-pie-chart"></i> Topic Analysis</div>
          <div class="tool-pill"><i class="bi bi-download"></i> Export Reports</div>
        </div>
      </div>
    </section>
    ...
    <section class="bottom-cta">
      <div class="container">
        <h2 style="font-family: var(--font-heading); font-size: 2.5rem; margin-bottom: 30px; color: var(--navy);">Ready to improve?</h2>
        <a href="sign-up.php" class="cta-btn-lg">Start Tracking Now</a>
      </div>
    </section>
