...
<head>
  ...
  <title>Collaborate & Share | ThinkUp</title>
...
<body>
  ...
  <main>
    <section class="feature-hero animate-load">
      <div class="container">
        <h1 class="feature-title">Connect Through <span style="color: var(--teal);">Creativity</span></h1>
        <p class="feature-subtitle">
          Learning is better together. Share your quizzes, challenge friends, and build a community of curious minds with just one click.
        </p>
        <img src="https://i.pinimg.com/736x/2c/18/62/2c18624e81f7df08a9bd79af9d936b0e.jpg" alt="Collaboration Icon" style="max-height: 300px; object-fit: contain; margin-top: 20px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
      </div>
    </section>

    <section class="steps-section">
      <div class="container">
        <h2 style="text-align: center; font-family: var(--font-heading); color: var(--navy); font-size: 2.5rem;">How to Share</h2>
        
        <div class="steps-grid">
          <div class="step-card">
            <div class="step-number">1</div>
            <h3 class="step-title">Publish Quiz</h3>
            <p>Once your masterpiece is ready, hit publish to make it accessible to your audience.</p>
          </div>
          
          <div class="step-card">
            <div class="step-number">2</div>
            <h3 class="step-title">Share the Link</h3>
            <p>Send your unique quiz link via social media, email, or direct message to friends and classmates.</p>
          </div>
          
          <div class="step-card">
            <div class="step-number">3</div>
            <h3 class="step-title">Compete Together</h3>
            <p>Watch the leaderboard fill up as people take your quiz and leave feedback in the comments.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="tools-section">
      <div class="container">
        <h2 class="tools-heading">Social Features</h2>
        <div class="tools-grid">
          <div class="tool-pill"><i class="bi bi-share-fill"></i> Social Sharing</div>
          <div class="tool-pill"><i class="bi bi-people-fill"></i> Team Mode</div>
          <div class="tool-pill"><i class="bi bi-trophy-fill"></i> Leaderboards</div>
          <div class="tool-pill"><i class="bi bi-chat-quote-fill"></i> Comments</div>
          <div class="tool-pill"><i class="bi bi-person-badge-fill"></i> Public Profiles</div>
          <div class="tool-pill"><i class="bi bi-globe"></i> Community Library</div>
        </div>
      </div>
    </section>
    ...
    <section class="bottom-cta">
      <div class="container">
        <h2 style="font-family: var(--font-heading); font-size: 2.5rem; margin-bottom: 30px; color: var(--navy);">Join the conversation</h2>
        <a href="sign-up.php" class="cta-btn-lg">Start Collaborating</a>
      </div>
    </section>
